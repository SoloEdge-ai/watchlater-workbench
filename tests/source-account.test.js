...
test("X bindings use a case-insensitive signed-in handle", () => {
  assert.deepEqual(Accounts.normalizeAccount("x", {
  ...
  assert.equal(Accounts.normalizeAccount("x", { id: "FridenZhang" }), null);
});
